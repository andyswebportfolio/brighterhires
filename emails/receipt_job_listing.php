<?php
    ...
    //if functions is included, turn it off for this part of the page
    
//Redeclare Session Vars, because this is testing outside the jobsaround URL
...
include 'mail_functions_embed.php';
require_once('../config.php');



//$test_email = 'andrew@awkwebdesign.com';

?>



<!-- Sends an email from welcome and adds @yourdomain.com on the end-->

<!-- button link set to http://www.brighterhires.online/verify_account.php -->

<!-- Line 259 you need to update the image source from awk web design site -->

<!-- placeholder asdfasdf text can be added to this email if you choose.-->


<?php

//Spoofs the unique url
//$_SESSION['unique_url'] = 'VER9zuGIHu';

/*Get data for email*/

//email address

if (isset($_SESSION['unique_url']) && isset($_SESSION['username'])) {
 $email_1 = pdo_return_embed("SELECT email FROM users WHERE username='".$_SESSION['username']."'")[0];

 $email_2 = pdo_return_embed("SELECT contact_email FROM listed_jobs WHERE page_link='".$_SESSION['unique_url']."'")[0];

 $stripe_id = pdo_return_embed("SELECT stripe_id FROM listed_jobs WHERE page_link='".$_SESSION['unique_url']."'")[0];

 $page_link = pdo_return_embed("SELECT page_link FROM listed_jobs WHERE page_link='".$_SESSION['unique_url']."'")[0];
} else {
 die();
}
...
//get the nickname of the plan the person just bought using

$subscription_name = \Stripe\Subscription::retrieve($stripe_id)['plan']['nickname'];

$subscription_price = \Stripe\Subscription::retrieve($stripe_id)['plan']['amount'];

setlocale(LC_MONETARY, 'en_GB');
$subscription_price = '&pound'.$subscription_price/100;



$pdo_data = array('account_email' => $email_1,
                  'listing_email' => $email_2,
                  'current_date' => date('d/n/y'),
                  'stripe_id' => $stripe_id,
                  'subscription_name' => $subscription_name,
                  'subscription_price' => $subscription_price,
                  'subscription_details' => "You will be charged automatically for the period you selected until the listing is cancelled.",
                  'page_link' => $page_link
                 );



$recipient_email = $pdo_data['account_email'];
$email_header = 'Email Receipt';
$header_2 = 'lol';

$content_1 = '
    Thank you for your purchase. This email acts as your receipt.
    <br><br>
    A copy of this receipt can be found at the email address listed on your job posting.
    <br><br>
    Your Email: '.$pdo_data['account_email'].'
    <br>
    Listed Email: '.$pdo_data['listing_email'].'
    <br>
    Listing Start Date: '.$pdo_data['current_date'].'
    <br>
    Product: '.$pdo_data['subscription_name'].'
    <br>
    Bill: '.$pdo_data['subscription_price']." - ".$_SESSION['period'].'
    <br><br>

    <p style="font-size:0.7em">Please note, subscription payments are processed at the time you took out the subscription. For example, if you take out a weekly subscription on Saturday at 1pm, payment is taken each Saturday around 1pm. Your listing can be cancelled anytime using your account. If you are having any problems cancelling your billing, please contact us at thejobswhale@gmail.com with your full name, email address and username. If you do not have all of these, please provide as many as you can. Although we make every effort to ensure any issues are resolved in the best way, if your account cannot be recovered, you will still be able to cancel your subscription directly through your bank. Since subscriptions never expire, please be aware that are responsible for cancelling the subscription at a time that is right for you - usually when you have found a suitable candidate for your listed job posting. Thank you for choosing Brighter Hires.
    <br> 
...
$text_2 = "Thank you.";
$button_1_text = "My Account";

$big_text_1 = "To see your listing and make any changes,";
$big_text_1_1 = "Visit \"My Account\" below.";
...
if ($_SESSION['localhost'] ==!NULL) {
    $url = 'http://localhost:8888/my_account.php';
} else {
    $url = 'http://www.brighterhires.online/my_account.php';
}

$_SESSION['email_verification_url'] = $url;
                
                $to = $pdo_data['account_email'].",".$pdo_data['listing_email'];
                $subject = "Email Receipt - Listing #".$pdo_data['page_link'];
...
<img class=\"center fixedwidth\" align=\"center\" border=\"0\" src=\"images/logo.png\" alt=\"Image\" title=\"Image\" style=\"outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: 0;height: auto;float: none;width: 100%;max-width: 275px\" width=\"275\">
...
<br>
	...
	<div style=\"color:#00d2b9;font-family:\'Lato\', Tahoma, Verdana, Segoe, sans-serif;line-height:120%; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;\">	
		<div style=\"line-height:14px;font-family:Lato, Tahoma, Verdana, Segoe, sans-serif;font-size:12px;color:#00d2b9;text-align:left;\"><p style=\"margin: 0;line-height: 14px;text-align: center;font-size: 12px\"><span style=\"font-size: 30px; line-height: 36px;\">".$email_header."</span></p></div>
	</div>
	<!--[if mso]></td></tr></table><![endif]-->
</div>
...
<div id=\"content_box_1\">
    <p id=\"header_1\" style=\"text-align:left\"> Dear ".$recipient_email.", </p>
    <br><br>
    <p id=\"content_text\">".$content_1."
    </p>
</div>
	...
	<div style=\"color:#555555;font-family:\'Lato\', Tahoma, Verdana, Segoe, sans-serif;line-height:120%; padding-right: 30px; padding-left: 30px; padding-top: 20px; padding-bottom: 15px;\">	
		<div style=\"font-family:Lato, Tahoma, Verdana, Segoe, sans-serif;line-height:14px;font-size:12px;color:#555555;text-align:left;\"><p style=\"margin: 0;line-height: 14px;text-align: center;font-size: 12px\"><span style=\"font-size: 34px; line-height: 40px;\"><em>".$text_2."</em></span><span style=\"font-size: 34px; line-height: 40px;\"><em></em></span></p><p style=\"margin: 0;line-height: 14px;text-align: center;font-size: 12px\"><span style=\"font-size: 34px; line-height: 20px;\"><em><br data-mce-bogus=\"1\"></em></span></p></div>	
	</div>
	<!--[if mso]></td></tr></table><![endif]-->
</div>
	...
	<div style=\"color:#00d2b9;font-family:\'Lato\', Tahoma, Verdana, Segoe, sans-serif;line-height:120%; padding-right: 0px; padding-left: 0px; padding-top: 0px; padding-bottom: 5px;\">	
		<div style=\"line-height:14px;font-family:Lato, Tahoma, Verdana, Segoe, sans-serif;font-size:12px;color:#00d2b9;text-align:left;\"><p style=\"margin: 0;line-height: 14px;text-align: center;font-size: 12px\"><span style=\"font-size: 22px; line-height: 26px;\">".$big_text_1." </span></p><p style=\"margin: 0;line-height: 14px;text-align: center;font-size: 12px\"><span style=\"font-size: 22px; line-height: 26px;\">".$big_text_1_1."</span></p></div>	
	</div>
	<!--[if mso]></td></tr></table><![endif]-->
</div>
...
<div align=\"center\" class=\"button-container center \" style=\"padding-right: 10px; padding-left: 10px; padding-top:10px; padding-bottom:10px;\">
  <!--[if mso]><table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" style=\"border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;\"><tr><td style=\"padding-right: 10px; padding-left: 10px; padding-top:10px; padding-bottom:10px;\" align=\"center\"><v:roundrect xmlns:v=\"urn:schemas-microsoft-com:vml\" xmlns:w=\"urn:schemas-microsoft-com:office:word\" href=\"".$_SESSION['email_verification_url']." style=\"height:31pt; v-text-anchor:middle; width:82pt;\" arcsize=\"0%\" strokecolor=\"#00d2b9\" fillcolor=\"#00d2b9\"><w:anchorlock/><v:textbox inset=\"0,0,0,0\"><center style=\"color:#ffffff; font-family:Arial, \'Helvetica Neue\', Helvetica, sans-serif; font-size:16px;\"><![endif]-->
    <a href=\"".$_SESSION['email_verification_url']."\"target=\"_blank\" style=\"display: block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #ffffff; background-color: #00d2b9; border-radius: 0px; -webkit-border-radius: 0px; -moz-border-radius: 0px; max-width: 110px; width: 70px;width: auto; border-top: 0px solid #A5CEA3; border-right: 0px solid #A5CEA3; border-bottom: 0px solid #A5CEA3; border-left: 0px solid #A5CEA3; padding-top: 5px; padding-right: 20px; padding-bottom: 5px; padding-left: 20px; font-family: Arial, \'Helvetica Neue\', Helvetica, sans-serif;mso-border-alt: none\">
      <span style=\"font-size:16px;line-height:32px;\">".$button_1_text."</span>
    </a>
