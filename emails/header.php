        ...
        <?php cookie_login_check();?> 
            <div class="row" id="nav_bar">
                <div class="section" id="nav_logo">
                    <a href="/">
                     ...
                     <img id="logo_mobile" src="img/header/logo.png" alt="logo">
                    </a>
                ...
                <div class="section" id="nav_links">
                    <ul>
                        <a href="list_a_job.php"><li class="button2">List Job</li></a>
            ...
            <div id="search_bar" style="height: 0px;">
                <form action="search.php" onsubmit="">
                    <input id="dropdown_search_bar" type="text" name="search" placeholder="Search Listings..." maxlength="75" style="display: none; height: 0px;">
            ...
            <div id="menu_dropdown">
                <h2></h2>
                <span></span>
                <ul><li style="font-size:1.5em">How can we help?</li>
                    <br><br>
