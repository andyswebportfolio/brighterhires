...
//Send the user back if the preceding page isn't the correct popup on the popup page

if(!isset($_SESSION['unlock_send_report'])) {
 push_back_instant('/404.php');
} else {
   unset($_SESSION['unlock_send_report']);
}
...
//1. Sending Email to User

//2. Sending Email to internal system
...
//////////////////////////////////////////////////////////////////////////////////////
//Re-routing after emails are sent
//////////////////////////////////////////////////////////////////////////////////////

// Redirect
$_SESSION['reported_message_emailled'] = 1;
