...
//Sends an email as of 20/7/20 at Cohub.
//Parameters are define before, and inserted in to one template.

//YOU MUST SET unlock_email as a session var to have this work! Spoof it here...
$_SESSION['unlock_email'] = 1;

//You need these to send the email. Again, spoof them here, use session irl.
//hehe, irl
$_SESSION['user_email'] = 'andrew.wells@hotmail.co.uk';
$user_email = $_SESSION['user_email'];

//BUTTONS
//The button link is not set. On the if statement near line 78, you can change that.


//Makes the redirect work for the 404. No, really. I'm not making that up. I have no idea why. PHP is weird lol. Also, constants don't seem to work for more than one page, even though the internet literally just lies about it. So that's fun.
//On that note...
define('unlock_includes',1);


//LEL AND KEK, MESS WITH ROOMBA, MEET YOUR DOOMBA
...
//`````````````````````````````````````````````````````````````````````````
// -- Include the functions.php file if it wasn't found.
...
//..........................................................................................
//Part 4 of 3 - F**k you. I didn't realise I would need a 4th part.
