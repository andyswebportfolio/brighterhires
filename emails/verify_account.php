...
/*2 sections commented out. Search for '/*' or maybe '\/* */


//Is set when everything is ready and pushed from page before
if(!isset($_SESSION['push_to_email'])) {
...
if ($_SERVER['HTTP_HOST'] == 'localhost:8888') {
    $url = 'http://localhost:8888/verify_account.php?y='.$y.'&z='.$z;
        //echo '<br>url to post to button is<br>'.$url.'<br>';
} else {
    $url = 'https://www.brighterhires.online/verify_account.php?y='.$y.'&z='.$z;
...
?>
            ...
            <?php
                ...
                $subject = "Welcome to Brighter Hires!";


                if ($_SERVER['HTTP_HOST'] == 'localhost:8888') {
                 $img_src_1 = 'images/logo.png';
                } else {
...
<br>
	...
	<div style=\"color:#00d2b9;font-family:\'Lato\', Tahoma, Verdana, Segoe, sans-serif;line-height:120%; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;\">	
		<div style=\"line-height:14px;font-family:Lato, Tahoma, Verdana, Segoe, sans-serif;font-size:12px;color:".$title_font_colour.";text-align:left;\"><p style=\"margin: 0;line-height: 14px;text-align: center;font-size: 12px\"><span style=\"font-size: 30px; line-height: 36px;\">Welcome to the site!</span></p></div>
	</div>
	<!--[if mso]></td></tr></table><![endif]-->
</div>
...
<br>
  ...
  <!--[if mso]><table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" style=\"border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;\"><tr><td style=\"padding-right: 10px; padding-left: 10px; padding-top:10px; padding-bottom:10px;\" align=\"center\"><v:roundrect xmlns:v=\"urn:schemas-microsoft-com:vml\" xmlns:w=\"urn:schemas-microsoft-com:office:word\" href=\"".$_SESSION['email_verification_url']." style=\"height:31pt; v-text-anchor:middle; width:82pt;\" arcsize=\"0%\" strokecolor=\"#00d2b9\" fillcolor=\"#00d2b9\"><w:anchorlock/><v:textbox inset=\"0,0,0,0\"><center style=\"color:#ffffff; font-family:Arial, \'Helvetica Neue\', Helvetica, sans-serif; font-size:16px;\"><![endif]-->
    <a href=\"".$_SESSION['email_verification_url']."\"target=\"_blank\" style=\"display: block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #000000; background-color: #61ff66; border-radius: 0px; -webkit-border-radius: 0px; -moz-border-radius: 0px; max-width: 110px; width: 70px;width: auto; border-top: 0px solid #A5CEA3; border-right: 0px solid #A5CEA3; border-bottom: 0px solid #A5CEA3; border-left: 0px solid #A5CEA3; padding-top: 5px; padding-right: 20px; padding-bottom: 5px; padding-left: 20px; font-family: Arial, \'Helvetica Neue\', Helvetica, sans-serif;mso-border-alt: none;border-radius:5px;\">
      <span style=\"font-size:16px;line-height:32px;\">Activate</span>
    </a>
...
//Part 3 of 3 - Technical Sending Details
               ...
               //Send the message, notify Session
