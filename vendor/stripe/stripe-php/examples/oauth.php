...
if (isset($_GET['code'])) {
    ...
    echo "<p>Error: code=" . htmlentities($error, ENT_QUOTES) . ", description=" . htmlentities($error_description, ENT_QUOTES) . "</p>\n";
    ...
    echo "<p>Success! Account <code>" . htmlentities($accountId, ENT_QUOTES) . "</code> is disconnected.</p>\n";
    echo "<p>Click <a href=\"?\">here</a> to restart the OAuth flow.</p>\n";
